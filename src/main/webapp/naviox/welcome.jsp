...
In servifabrik-labels_en.properties:
servifabrik=My application
servifabrik[description]=My application does this and that

In servifabrik-messages_en.properties:
